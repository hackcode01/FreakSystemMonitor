#ifndef __PH_NT_WINDOWS_HPP__
#define __PH_NT_WINDOWS_HPP__
...
#ifndef MAXLONGLONG
#define MAXLONGLONG (7fffffffffffffffULL)
#endif
...
#ifdef __cplusplus
#define RTL_ADDRESS_OF(v) (&const_cast<char&>(reinterpret_cast<const volatile char&>(v)))
#else
...
/**
 * Some parts of the Windows Runtime, COM or third party hooks are returning
